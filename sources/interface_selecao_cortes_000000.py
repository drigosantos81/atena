...
class SelecaoLayout():
    ...
    #opcoesconf
    opcoes_conf_sm = ['CONVENCIONAL','DISJUNTOR','RECORTE','RECORTE_BAIXA','BAIXA MIX','MISTA']
    opcoes_suscetiveis = ['CONVENCIONAL','DISJUNTOR','RECORTE','RECORTE_BAIXA','BAIXA MIX','MISTA']
    #opcoes_carteira_def
    #Tabela Hana
    ...
    def consulta_selecao(self,b,usuario,senha):
        ...
        try:
            ...
            if consulta == 'Tabela Suscetiveis':
                ...
                if carteira_sql in self.opcoes_conf_sm:
    ...
    def container_suscetiveis(self):
        ...
        #self.consulta_drop = st.selectbox('Onde Consultar:', ['Tabela Suscetiveis', 'Arquivo SQL'])
    ...
    def resultados_hana(self):
        ...
        if self.carteira_sm in self.opcoes_conf_sm:
            valor_carteira = self.carteira_sm
        else:
            valor_carteira= self.opcoes_conf_sm[0]
        ...
        self.carteira_wgt = widgets.Dropdown(value= valor_carteira,layout=widgets.Layout(width="150px", height='30px', margin="0px 20px 0px 0px"),
