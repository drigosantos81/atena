        ...
        try:
            for i in arquivo.MARCACAO.unique():
                if arquivo.loc[arquivo['MARCACAO']==i]['MARC_ZONA'].unique()[:3][0] == 'MIX_':
                    for clusters in  arquivo.loc[arquivo['MARCACAO']==i]['cluster'].unique():
                        if arquivo.loc[(arquivo['MARCACAO']==i) & (arquivo['cluster']==clusters)].ZONA.unique().shape[0] == 1:
                           arquivo.loc[(arquivo['MARCACAO']==i) & (arquivo['cluster']==clusters),'MARC_ZONA'] = \
                                         arquivo.loc[arquivo[(arquivo['MARCACAO']==i) & (arquivo['cluster']==clusters)]].ZONA.unique()[0]
