...
class SelecaoCorte():
    ...
    cores = ['blue', 'red', 'orange', 'green', 'beige', 'white', 'darkgreen', 'darkblue','lighgren', 'lightred']
    ...
    def selecionar(self, UTD: str,locali: list = None,zona: list = None, municipio: list = None, bairros: list = None, metodo: str = 'nkcnk',
        ...
        self.nomes_clusters = []
        self.cores = ['blue', 'red', 'orange', 'green', 'beige', 'white', 'darkgreen', 'darkblue','lighgren', 'lightred']
        for i in range(n):
