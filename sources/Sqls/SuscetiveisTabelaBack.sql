DO BEGIN 
   ...
   WHERE ZCGACCOUN IN (SELECT ZCGACCOUN FROM CLB961920."#TAB" 
                           WHERE UTD = 'FEIRA DE SANTANA NORTE'
                            AND ZCGBAIRRO IN (
                                'FAZ GAMELEIRA', 'BARRA', 'BANDARRA', 'RURAL - MAO DE ONCA','RURAL - SANTA ROSA',
                                'MAQUINE','RURAL-BOCA DA MATA','RURAL - INGONCO','RURAL-SANTO ESTEVAO','RURAL - CACIMBA',
                                'RURAL-IPECAETA','RURAL - CONGUINHO','CONGA','EST IPECAETA','CABORONGA','RURAL - AGUA BRANCA',
                                'RURAL-OLEIROS','RURAL-JAGUARA','RURAL-PEDRA FERRADA','RURAL-BOMFIM DE FEIRA',
                                'RURAL-ESTRADA DO FEIJAO','RURAL-CAGADO','ALTO ALEGRE','MANGABA DA TERRA','XANDU',
                                'RURAL - BAIXA FRIA','ASSENTAMENTO DOM MATHIAS','CALDEIRAO DA VELHA'
                                )
                      )
          AND CURRENT_DATE = '20220513';
    END IF;
