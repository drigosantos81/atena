...
from sources.selecao_cortes_2_0 import *
...
class SelecaoLayout():
    ...
    def importar_clusterconf(self, b):
        ...
        try:
            ...
            #inserido/adicionado no atena novo 30-08-2022 ---------
            # Em dias de feriado, trocar o ADD_DAYS(CURRENT_DATE,0) por ADD_DAYS(CURRENT_DATE,1)
            import datetime
            import time
            ...
            data_insercao_amanha = data_amanha
            ...
            query = """
                DELETE FROM CLB344173.HISTORICO_MAPA_SELECAO WHERE DATA_PEDIDO = '{var_data_insercao}';
                    """
            myRow = cursor.execute(query.format(var_data_insercao=data_insercao_amanha))
            query = """
