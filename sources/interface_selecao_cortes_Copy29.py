...
class SelecaoLayout():
    ...
    def consulta_selecao(self,b,usuario,senha):
        ...
        try:
            ...
            if consulta == 'Tabela Suscetiveis':
                ...
                list_confg = ['sources/Sqls/'+self.tabelasuscetiveis+'.sql',carteira_sql,data_pedido,self.turma_sm]
    ...
    def container_suscetiveis(self):
        ...
        self.turma_drop = widgets.Dropdown(value =self.opcoes_turma_sm[0] ,options = self.opcoes_turma_sm,layout= widgets.Layout(width = '200px',height='30px',margin = conf_pixel))
        ...
        sql_select_label = widgets.Label('Selecione Carteira ou SQL:',layout=widgets.Layout(width = '200px', height = '40px', 
                                                                                  margin = conf_pixel))
        self.sql_select = widgets.Dropdown(options = self.opcoes_suscetiveis_stc,layout=widgets.Layout(width = '200px', height = '30px', margin = conf_pixel))
        ...
        label_date_picker = widgets.Label('Escolha a data de Pedido:', layout = widgets.Layout(width = '200px',height = '40px',
                                                                                              margin = conf_pixel))
        self.date_picker = widgets.DatePicker(value = today ,layout = widgets.Layout(width = '200px',height = '40px',margin = conf_pixel))
