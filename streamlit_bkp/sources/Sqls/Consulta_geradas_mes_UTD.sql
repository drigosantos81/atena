SELECT UTD, TURMA, CARTEIRA, SUM(QTD_GERADAS) AS QTD_GERADAS, SUM(PECLD_GERADAS) AS PECLD_GERADAS, SUM(PECLD_GERADAS)/SUM(QTD_GERADAS) AS TICKET_PECLD_GERADAS FROM (
