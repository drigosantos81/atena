...
SELECT UTD, TURMA, CARTEIRA, SUM(NOTAS_ESPERADAS_ATENA) as NOTAS_ESPERADAS_ATENA, SUM(NOTAS_GERADAS_TAB4) as NOTAS_GERADAS_TAB4, SUM(DEFASAGEM_GERACAO) as DEFASAGEM_GERACAO FROM (
--ABAIXO SQL ORIGINAL POR ZONA
