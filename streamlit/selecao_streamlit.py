...
if 1 == 0:
    with st.sidebar: # Menu lateral
        ...
        st.session_state.pagina = option_menu(None, ["Login", "Consultas", "Seleção", "Configurações", "Dashboard","Sobre"],
                            icons=['person', 'search','coin', 'gear','graph-up','info-circle'],
...
LEFT JOIN CLB_CCS_ICC.ZCT_DS_FCC001 FCC001
    ...
    ON TEMP_ATENA.ZCGACCOUN = RECORTE.ZCGACCOUN	
        ...
        st.session_state.base_suscetiveis[['ZONA','BASE CLICK','LOCALIDADE','EVOLUCAO_LEITURA']] = st.session_state.base_suscetiveis[['ZONA','BASE CLICK','LOCALIDADE','EVOLUCAO_LEITURA']].fillna("-")
    ...
    if len(base_df) > 0:
        ...
        for i, row in base_df.iterrows():
            ...
            if atalho_pacote_2  == '99' or atalho_pacote_2  == '83' or atalho_pacote_2  == '36':
                ...
                cor = 'pink'
                cor_fundo = cor
            elif atalho_pacote_2  == '15' or atalho_pacote_2  == '46':
                cor = 'lightblue'
                cor_fundo = cor
                ...
                cor = 'lightblue'
                cor_fundo = cor
            elif atalho_pacote_2  == '19' or atalho_pacote_2  == '26':
                cor = 'red'
                cor_fundo = 'lightgray'
            elif atalho_pacote  == '1':
                cor = 'red'
                cor_fundo = cor
            elif atalho_pacote_2  == '96' or atalho_pacote_2  == '70':
                cor = 'darkred'
                cor_fundo = 'lightgreen'
